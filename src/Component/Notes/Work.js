    ...
    const addToDoList = async (e) => {
        ...
        try {
            let req = await axios.post(
                `http://ec2-13-235-50-78.ap-south-1.compute.amazonaws.com:9045/toDoListdata/`,
                {
    ...
    const getTodolist = async () => {
        try {
            ...
            let req = await axios.get(
                `http://ec2-13-235-50-78.ap-south-1.compute.amazonaws.com:9045/toDoListdata/specificUser/${y}`,
                {
                    headers: {
                        authtoken: window.localStorage.getItem("token"),
                    },
    ...
    const delToDolist = async (id) => {
        ...
        try {
            let req = await axios.delete(
                `http://ec2-13-235-50-78.ap-south-1.compute.amazonaws.com:9045/toDoListdata/deleteToDoListData/${id}`,
                {
                    headers: {
                        authtoken: window.localStorage.getItem("token"),
                    },
    ...
    const editToDoList = async () => {
        try {
            ...
            const response = await axios.put(
                `http://ec2-13-235-50-78.ap-south-1.compute.amazonaws.com:9045/toDoListdata/edit/${updateId}`,
                {
                    userid: window.localStorage.getItem("id"),
                    type: "Work",
